...
execution=int(input("Programme de calculations pour Agriculteurs\n"
...
match execution:
    case 1:
        ...
        execution=int(input("\nSouhaitez-vous passer à la prochaine option ?, Si oui, veuillez taper '2' : "))
# POUR 5.3, 5.3.1 ET 5.3.2
match execution:
    case 2:
        ...
        execution=int(input("\nSouhaitez-vous passer à la prochaine option ?, Si oui, veuillez taper '3' : "))
